...
class Project(models.Model):
    ...
    # imgSrc = models.ImageField("png이미지소스", upload_to='projectImg/<int:pk>', blank=True, null=True)
    # gifSrc = models.ImageField("gif이미지소스", upload_to='projectImg/<int:pk>', blank=True, null=True)
