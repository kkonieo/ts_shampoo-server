        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        db_index=True, max_length=10, verbose_name="유저 이름"
                    ),
                ),
                (
                    "email",
                ...
                (
                    "img",
                    models.CharField(
                        blank=True, max_length=200, null=True, verbose_name="이미지"
                    ),
                ),
                ...
                (
                    "is_verified",
                    models.BooleanField(default=False, verbose_name="email 인증자"),
                ),
